    ...
    return (
        <div className='dark_mode'>
            <input
                ...
                id='darkmode-toggle'
            />
            <label onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className='dark_mode_label' htmlFor='darkmode-toggle'>
                ...
                <svg
                    ...
                    <rect
                        ...
                        y="361.915"
                    />
                    <rect height="72" width="16" x="240" y="424" />
                    <rect
                        height="16"
                        ...
                        y="389.915"
                    />
                    <rect height="16" width="72" x="424" y="240" />
                    <rect
                        height="71.999"
