...
import img1 from './imageasset/1.png'
import img9 from './imageasset/2.png'
import img3 from './imageasset/3.png'
import img4 from './imageasset/4.png'
import img5 from './imageasset/5.png'
import img6 from './imageasset/6.png'
import img7 from './imageasset/7.png'
import img2 from './imageasset/8.png'
...
function AdminPanel() {
    ...
    const handleadminsigninform = async (e) => {
        e.preventDefault()
            ...
            <div className="adminauth">
                <div className='adminauthform'>
                    <div className='leftsidelogin'>
                        <h1 className="blogbookheading">BlogBook</h1>
                        {/* <h5 className="adminheading">ADMIN</h5> */}
                    </div>
                    ...
                    <div className="rightsidelogin">
                        <div className="loginbox">
                            ...
                            <div className='blackmirror'></div>
                            <form className="adminloginform" onSubmit={handleadminsigninform}>
                                {/* <h1>BlogBook</h1> */}
                                <p className="adminpara">ADMIN</p>
                                <input type="email" name="email" placeholder="email" value={formData.email} onChange={handleadminformonchange} />
                                <input type="password" name="adminkey" placeholder="admin key" value={formData.adminkey} onChange={handleadminformonchange} />

                                <button className='adminsigninbutton' type='submit'>Sign In</button>

                                {/* <div className='coninuewithgoogle'>
                                <svg className='googlelogo' xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262" >
                ...
                <div className="adminPanel">
                    <div className='adminsidebar'>
                        <p className="slidebutton"><svg id='adminsvg' xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" >
                            <path d="M12 19V5M18 19V5M6 19V5" stroke="#000000" strokeWidth="2" strokeLinecap="round" />
                        </svg></p>
                        ...
                        <div className="sidebaroption">
                            <div className="optionbox">
                                ...
                                <p className="admindashboard options"><svg className='adminoptionsvg' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Layer_1" viewBox="0 0 24 24" xmlSpace="preserve">
                                ...
                                <div className='optionline'></div>
                                <p className="admindashboard options"><svg className='adminoptionsvg svgcurrency' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="800px" width="800px" version="1.1" id="_x32_" viewBox="0 0 512 512" xmlSpace="preserve">

                                    <g>
                                        <path d="M318.213,66.588h107.818L465.37,0H85.969L46.63,66.588h145.727c32.137,9.476,58.259,28.504,72.702,52.656   H85.969l-39.34,66.588h227.316c-13.482,45.473-65.618,79.365-127.924,79.365H68.313v60.013L288.818,512h96.012v-23.222   L183.333,321.936c84.557-3.351,153.634-61.218,166.283-136.105h76.415l39.339-66.588H345.687   C340.062,100.028,330.637,82.256,318.213,66.588z" />
                                    </g>
                                </svg> Billings</p>
